...
constexpr auto max_len_username = 32u;
constexpr auto max_len_password = 16u;
constexpr auto max_len_error_message = 256u;
constexpr auto max_len_room_name = 32u;
constexpr auto max_len_chat_message = 128u;
